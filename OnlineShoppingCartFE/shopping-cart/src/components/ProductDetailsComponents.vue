                                    ...
                                    <div id="owl-single-product">
                                        <div class="single-product-gallery-item" id="slide1">
                                            <a data-lightbox="image-1" data-title="Gallery"
                                                ...
                                                <img class="img-responsive" alt="" :src="product.imageProduct">
                                            </a>
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="quantity-container info-container">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <a @click="addToCart" href="#" class="btn btn-primary"><i
...
export default {
    ...
    methods: {
        loadProductById() {
            ...
            var url = process.env.VUE_APP_BASE_API_URL + `/Products/${id}`;
            axios.get(url)
                .then(response => {
